...
Grid<unsigned char> dis_left, dis_right;
...
void refinement(Grid<type>& d_left, Grid<type>& d_right) {
    ...
    save_image("lefterror.pgm", occlusion_left);
    save_image("righterror.pgm", occlusion_right);
}
...
int main(int args, char ** argv) {
    ...
    try {
        ...
        // load_image_gray(file_name[2], dis_left);
        // load_image_gray(file_name[3], dis_right);
    } catch (...) {
